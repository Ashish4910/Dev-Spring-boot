...
import com.ashish.spring.rest.CrudDemo.entity.Review;
...
public class CrudDemoApplication {
	...
	private void deleteCourseAndReview(AppDAO appDAO) {
		...
		System.out.println("Deleting the Course where id is "+theId);
	...
	private void findCourseAndReview(AppDAO appDAO) {
		...
		// retrieve the course
		int theId = 10;
		Course theCourse = appDAO.findCourseAndReviewById(theId);
		// display the course
		System.out.println("Displaying the Course " + theCourse);
		// display the review
		System.out.println("Display the Review " + theCourse.getAddReview());
		System.out.println("Done !!");
	...
	private void createCourseWithReview(AppDAO appDAO) {
		...
		// save the Course and Review

		Course theCourse = new Course("Review Entity Course ");

		theCourse.addReview(new Review("Very Good course ! loved ittt !!.. "));
		theCourse.addReview(new Review("Very bad  course ! "));
		theCourse.addReview(new Review("Very stupid Course !! "));
